...
function DFlipFlopCard() {
  ...
  return (
    <FlipFlopShell
      ...
      diagram={<DFlipFlopDiagram vdd={vdd} qm={d.voltages.QM ?? 0} q={d.q} pulseTick={pulseTick} />}
      truthTable={
        <TruthTable
          headers={['D', 'Q(next)']}
          rows={[
...
function JkFlipFlopCard() {
  ...
  return (
    <FlipFlopShell
      ...
      diagram={<JkFlipFlopDiagram vdd={vdd} qm={jk.voltages.QM ?? 0} q={jk.q} pulseTick={pulseTick} />}
      truthTable={
        <TruthTable
          headers={['J', 'K', 'Q(next)']}
          rows={[
...
function TFlipFlopCard() {
  ...
  return (
    <FlipFlopShell
      ...
      diagram={<TFlipFlopDiagram vdd={vdd} qm={t.voltages.QM ?? 0} q={t.q} pulseTick={pulseTick} />}
      truthTable={
        <TruthTable
          headers={['T', 'Q(next)']}
          rows={[
