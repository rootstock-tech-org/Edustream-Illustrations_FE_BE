...
export default function DemoLecturePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <p className="text-xs font-semibold uppercase tracking-wide text-[var(--indigo)]">Module 11 · Semiconductor Packaging &amp; Final Test</p>
      <h1 className="mt-1 text-2xl font-bold text-[var(--text)]">Ch11.9 — HBM, CoWoS &amp; Foveros</h1>
