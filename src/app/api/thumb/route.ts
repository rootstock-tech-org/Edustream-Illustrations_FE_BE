...
const KEYWORDS = [
  "Universal Robots", "Boston Dynamics", "Figure", "Tesla Optimus", "Cobot",
  "Humanoid", "Manipulator", "Gripper", "Drone", "UAV", "AMR", "AGV",
  "ABB", "KUKA", "Yaskawa", "FANUC", "NVIDIA", "Isaac", "ROS", "SLAM",
  "Robot", "Automation", "Warehouse", "Actuator", "Perception", "Grasping",
...
async function openverseImage(keyword: string, signal: AbortSignal): Promise<string | null> {
  const queries = [`${keyword} robot`, "robot automation technology"];
